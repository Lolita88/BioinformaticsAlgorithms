...
"""
    Usages:
    ./test4.py                  (reads out the entire config dict)
    ./test4.py                  (sets 'thiskey' and 'thisvalue' in the dict)
"""
import sys
from Assignment3 import ConfigKeyError
from Assignment3 import ConfigPickleDict      # assumes "Assignment3.py holds a 
...
# if 1 arguement on the command line, treat it as a key and show the value
elif len(sys.argv) == 2:
